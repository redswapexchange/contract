...
import '@uniswap/v2-core/contracts/interfaces/ISwapFactory.sol';
...
contract SwapRouter01 is ISwapRouter01 {
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return SwapLibrary.getAmountOut(amountOut, reserveIn, reserveOut);
    }
